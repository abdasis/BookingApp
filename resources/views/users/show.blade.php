                ...
                <div class="card-inner">
                    <div class="row">
                        <div class="col-sm-3 text-center">
                            <img id="previewImage" src="{{ asset('') }}storage/foto/{{ $foto }}" alt="Preview Foto"
                                class="rounded-circle img-thumbnail"
                                style="width: 150px; height: 150px; object-fit: cover; border: 2px solid #6B6EF5;">
                            ...
                            <div class="row mb-3">
                                <div class="containter">
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                        data-bs-target="#modalForm">Pilih Avatar</button>
                                    <button type="button" class="btn btn-info" style="background-color: #6B6EF5;"
                                        id="uploadFoto">Upload</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            ...
                            <div class="text-center mb-3">
                                <h4 style="color: #6B6EF5;">{{ $total }}</h4>
                            </div>
                                        ...
                                        <div class="gallery card">
                                            <a class="#">
                                                <img class="w-100 rounded-top"
                                                    src="{{ url('storage/lencana/' . $gambar->gambarLencana) }}"
                                                    alt="">
                                            </a>
    ...
    <span class="text-center">{{$lencana[0]->capaianPoin}}</span>
                                ...
                                @else
                                    <div class="col-sm-6 col-lg-4 col-xxl-3">
                                        <div class="gallery card">
                                            <a class="#">
                                                <img class="w-100 rounded-top"
                                                    src="{{ url('storage/lencana/' . $lencana[1]->gambarLencana) }}"
                                                    alt="">
                                            </a>
                                ...
                                @else
                                    <div class="col-sm-6 col-lg-4 col-xxl-3">
                                        <div class="gallery card">
                                            <a class="#">
                                                <img class="w-100 rounded-top"
                                                    src="{{ url('storage/lencana/' . $lencana[2]->gambarLencana) }}"
                                                    alt="">
                                            </a>
                                ...
                                @else
                                    <div class="col-sm-6 col-lg-4 col-xxl-3">
                                        <div class="gallery card">
                                            <a class="#">
                                                <img class="w-100 rounded-top"
                                                    src="{{ url('storage/lencana/' . $lencana[3]->gambarLencana) }}"
                                                    alt="">
                                            </a>
                ...
                <div class="card-inner">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('nip', null, ['placeholder' => 'NIP Anda', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('jabatan', null, ['placeholder' => 'Jabatan Anda', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('unitKerja', null, ['placeholder' => 'Unit Kerja Anda', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('instansi', null, ['placeholder' => 'Instansi Kerja Anda', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <br>
                                <strong>Password:</strong> <span class="text-danger">Kosongkan Jika Tidak Ingin
                                    Mengubah</span>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <br>
                                <strong>Confirm Password:</strong> <span class="text-danger">Kosongkan Jika Tidak Ingin
                                    Mengubah</span>
                    ...
                    <div class="col-12 mt-3 text-end">
                        <button type="button" class="btn btn-primary" style="background-color:#6b6ef5;"
                            style="background-color: #6B6EF5;" id="btnSimpan">Simpan Perubahan</button>
                    </div>
                </div><!-- .card-inner -->
            </div>
        </div>
                                    ...
                                    <div class="preview-block">
                                        ...
                                        <div class="custom-control custom-radio image-control">
                                            <input type="radio" class="custom-control-input"
                                                value="{{ $avatars->avatar }}" id="imageRadio{{ $key + 1 }}"
                                                name="imageRadio">
                                            <label class="custom-control-label" for="imageRadio{{ $key + 1 }}"><img
                                                    src="{{ url('storage/foto/' . $avatars->avatar) }} " width="150"
                                                    height="150" alt=""></label>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                Swal.fire('Berhasil!',
                                    'Data pengguna berhasil diperbarui.', 'success');
                                location.reload();
                            },
