      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" name="tarifWd" placeholder="Tarif Minggu - Kamis" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Tarif WeekEnd</label>
              <input type="number" class="form-control" name="tarifWe" placeholder="Tarif Jumat - Sabtu" required>
            </div>
            <div class="mb-3">
                ...
                <div class="form-selectgroup">
                    @foreach($fasilitas as $item)
                              <label class="form-selectgroup-item">
                                <input type="checkbox" name="layanan[]" value="{{$item->nama}}" class="form-selectgroup-input">
