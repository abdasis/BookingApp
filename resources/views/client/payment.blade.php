                   ...
                   <div class="card">
                       ...
                       <div class="card-body">
                               ...
                               <div class="accordion-item">
                                   <h2 class="accordion-header" id="heading-2">
                                       <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                           ...
                                           <img src="{{ asset('assets/img/payments/2.png') }}" width="100px">
                                       </button>
                                   </h2>
                           ...
                           <form id="formbayar" enctype="multipart/form-data" method="POST">
                               ...
                               <a href="https://wa.me/085830223422?text=Halo%20konfirmasi%20pemesanan%20kamar%20id%20booking%20{{ $data->id }}"
       ...
       <script>
           $(document).ready(function() {
               $('#submitPayment').click(function(e) {
                   ...
                   $.ajax({
                       url: "{{ route('booking.update', ['id' => ':id']) }}".replace(':id', $(
                           '#idbooking').val()),
                       type: 'POST',
                       data: formData,
                       processData: false,
