...
<div class="accordion mb-2" id="accordion-example">
                                       ...
                                       <div class="accordion-body pt-0">
                                           <strong>
                                               ...
                                               <p>Atas Nama Bukit Gading Mas</p>
                                                <button class="btn btn-outline-red" onclick="copyContent()">Salin Rekening</button>
                                           </strong>
                                       </div>
                                   </div>
                               </div>
                           ...
                           <form id="formbayar" enctype="multipart/form-data" method="POST">
                            ...
                            <a href="https://wa.me/{{$wa->hp}}?text=Halo%20konfirmasi%20pemesanan%20kamar%20Kode%20booking%20{{ $data->id }}" target="blank" class="btn w-100">
