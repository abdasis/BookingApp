   ...
   @section('content')
           ...
           <div class="row justify-content">
               <div class="col-md-12">
                   ...
                   @elseif ($data->Status == 3)
                       <div class="card bg-success text-primary-fg">
                           ...
                           <div class="card-body">
                               <h2 class="card-title">Selamat Pembayaran Anda Berhasil !</h2>
                               <p>Username dan Password Akan Dikirim Ke Email Setelah Dikonfirmasi Admin</p>
                           </div>
                       </div>
                   @else
                       <div class="card bg-success text-primary-fg">
               ...
               <div class="col-md-12 mt-3">
                   <div class="card">
                       ...
                       <div class="card-body">
                           <dl class="row">
                               <dt class="col-4">#ID / Kode Booking</dt>
                               <dd class="col-8">: #{{ $data->id }}</dd>
                               <dt class="col-4">Room</dt>
                               <dd class="col-8">: {{ $data->roomtypes->nama }}</dd>
                               <dt class="col-4">Check In:</dt>
                               <dd class="col-8">: {{ $data->checkIn }}</dd>
                               <dt class="col-4">Check Out:</dt>
                               <dd class="col-8">: {{ $data->checkOut }}</dd>
                                   ...
                                   <div id="collapse-1" class="accordion-collapse collapse"
                                       ...
                                       <div class="accordion-body pt-0">
                                           <strong>
                                               ...
                                               <button class="btn btn-outline-red" onclick="copyContent()">Salin
                                                   Rekening</button>
                                           </strong>
                                       </div>
                                   </div>
                           ...
                           <form id="formbayar" enctype="multipart/form-data" method="POST">
                               ...
                               <a href="https://wa.me/{{ $wa->hp }}?text=Halo%20konfirmasi%20pemesanan%20kamar%20Kode%20booking%20{{ $data->id }}"
                                   target="blank" class="btn w-100">
       ...
       <script>
           ...
           $('#submitPayment').click(function(e) {
               ...
               $.ajax({
                   url: "{{ route('booking.update', ['id' => ':id']) }}".replace(':id', $('#idbooking')
                       .val()),
                   type: 'POST',
                   data: formData,
                   processData: false,
