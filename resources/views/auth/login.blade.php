      ...
      <div class="container container-normal py-4">
        <div class="row align-items-center g-4">
          <div class="col-lg">
            <div class="container-tight">
              <div class="text-center mb-4">
                <a href="." class="navbar-brand navbar-brand-autodark"><img src="{{asset('assets/logo/iconlogo.png')}}" height="36" alt=""></a>
              </div>
          ...
          <div class="col-lg d-none d-lg-block">
            <img src="{{asset('assets/logo/logo.png')}}" height="300" class="d-block mx-auto" alt="">
          </div>
        </div>
      </div>
    </div>
